...
export function Astronaut(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/models/AstroManFalling.glb')
  ...
  const ySpring = useSpring(yPosition, {dampling: 30});
  useEffect(()=>{
    ySpring.set(-1);
  },[ySpring])
  useFrame(()=>{
...
useGLTF.preload('/models/AstroManFalling.glb')